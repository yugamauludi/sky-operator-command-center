...
export default function Dashboard() {
  ...
  // Data dummy untuk chart complain per hari
  const dailyComplaintOptions: ApexOptions = {
    chart: {
      type: "candlestick" as ApexChart["type"],
      height: 350,
      background: "transparent",
      foreColor: "inherit",
    },
    title: {
      text: "Total Komplain per Hari",
      style: {
        color: "currentColor",
      },
    },
            ...
            <div className="container mx-auto px-6 py-8">
              ...
              <div className="bg-white dark:bg-[#222B36] p-4 rounded-lg mb-8">
                ...
                {isPanduanVisible && (
                  <ul className="list-disc list-inside text-sm space-y-1 mt-2">
                    <li>
                      Klik tombol {"Proses"} untuk mulai menangani bantuan
                    </li>
                    <li>
                      Klik tombol {"Selesai"} jika bantuan sudah diselesaikan
                    </li>
                    <li>
                      Suara akan berbunyi jika ada permintaan bantuan baru
                    </li>
                    <li>
                      Klik tombol {"Tes Suara"} untuk menguji notifikasi suara
                      dan getaran
                    </li>
                  </ul>
                )}
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white dark:bg-[#222B36] text-gray-900 dark:text-gray-100 p-4 rounded-lg">
                  <ReactApexChart
                    options={{
                      ...dailyComplaintOptions,
                      chart: {
                        ...dailyComplaintOptions.chart,
                        background: "transparent",
                      },
                      theme: {
                        mode: "light",

...
export default function CheckTicketModal({
  ...
  const getVehicleStatus = (
    ...
    if (outTime === null) {
      // Kendaraan masih di dalam area
      return "IN AREA";
    } else if ((outTime !== null && paymentStatus === "PAID") || "FREE") {
      // Kendaraan sudah keluar dan sudah bayar
      return "OUT AREA";
    }
    return "UNKNOWN";
  };
  ...
  return (
    <div className="fixed inset-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm flex items-center justify-center z-50">
      <div
        className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-[1000px] mx-4 shadow-2xl border border-gray-200 dark:border-gray-700"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="h-[44px]">
                <input
                  ...
                  className={`w-full h-full px-3 py-2 border ${
                    plateError
                      ? "border-red-500"
          ...
          <div className="flex flex-row gap-4 pt-2 justify-end">
            <button
              type="button"
              onClick={handleClose}
              className="cursor-pointer px-6 py-2 rounded-md text-sm font-medium border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition"
              style={{ minWidth: 120 }}
            >
              Batal
            </button>
            <button
              ...
              className={`cursor-pointer px-6 py-2 rounded-md text-sm font-medium text-white transition focus:outline-none focus:ring-2 focus:ring-blue-500
                ${
                  loading || plateError
                  ...
                  {ticketData.PaymentStatus === "PAID" && (
                    <>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-sm font-mono bg-white dark:bg-gray-800 py-1 rounded">

            ...
            {totalLocationPages > 1 && (
                <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
                    <div className="text-sm text-gray-700 dark:text-gray-300">
                        Menampilkan {startLocationIndex + 1} - {Math.min(endLocationIndex, filteredLocations.length)} dari {filteredLocations.length}
                        {selectedRegion !== 'all' && (
                            ...
                            return getVisiblePages().map((page, index) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`cursor-pointer w-8 h-8 flex items-center justify-center text-xs rounded border ${currentLocationPage === page

            ...
            <div className="bg-white dark:bg-gradient-to-br dark:from-[#1a2332] dark:to-[#222b36] rounded-2xl max-w-6xl w-full h-[90vh] flex flex-col overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <div className="flex bg-white dark:bg-[#2a3441] rounded-lg p-1 border border-gray-200 dark:border-gray-600">
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-md text-sm font-medium transition-colors duration-200 ${viewMode === 'table'
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-md text-sm font-medium transition-colors duration-200 ${viewMode === 'card'
                                        ? 'bg-blue-500 text-white shadow-sm'
                                        : 'text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200'
                                        }`}
                                >
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                            ...
                            <div className="flex items-center space-x-1">
                                ...
                                <button
                                    ...
                                    className="px-2 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-[#2a3441] hover:bg-gray-50 dark:hover:bg-[#323b4a] disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                                ...
                                <button
                                    ...
                                    disabled={currentPage === 1}
                                    className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-[#2a3441] hover:bg-gray-50 dark:hover:bg-[#323b4a] disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex space-x-1">
                                    {getPaginationRange()[0] > 1 && (
                                        <>
                                            <button
                                                onClick={() => handlePageChange(1)}
                                                className="px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 text-gray-700 dark:text-gray-300 bg-white dark:bg-[#2a3441] border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-[#323b4a]"
                                            >
                                                1
                                            </button>
                                    ...
                                    {getPaginationRange().map((pageNumber) => (
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 min-w-[40px] ${currentPage === pageNumber
                ...
                <div className="bg-white dark:bg-[#222b36] px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center flex-shrink-0">
                    <div className="flex space-x-3">
                        <button className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200 text-sm font-medium">
                            <svg className="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            Export Data
                        </button>
                        <button className="px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors duration-200 text-sm font-medium">
                            <svg className="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                        onClick={onClose}
                        className="px-6 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition-colors duration-200 text-sm font-medium"
                    >
                        Tutup
                    </button>
                </div>
